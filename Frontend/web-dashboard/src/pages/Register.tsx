...
export const Register: React.FC = () => {
  ...
  const passwordMismatch =
    confirmTouched && confirmDisplay !== formData.password;
  const passwordMatch =
    confirmTouched &&
    confirmDisplay === formData.password &&
    confirmDisplay !== "";
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-4 text-blue-100 text-lg leading-relaxed">
              Track opens, clicks, and conversions — all in one powerful
              dashboard.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Live open and click tracking",
              },
              {
                icon: <Zap size={20} />,
                title: "AI-powered insights",
                desc: "Optimize send times automatically",
              },
              {
                icon: <Globe size={20} />,
                title: "Global deliverability",
                desc: "Reach inboxes, not spam folders",
              },
            ].map((f) => (
